...
describe( "List", function()
    describe( "new()", function()
        describe( "when no initial values specified", function()
            local q = List:new()
        ...
        describe( "when initial items specified", function()
    ...
    describe( "push()", function()
        describe( "when pushing a nil", function()
        ...
        describe( "when pushing an integer", function()
            local q = List:new()
            local item = 12
            q:push( item )
        ...
        describe( "when pushing a table", function()
            local q = List:new()
    ...
    describe( "pop()", function()
        ...
        describe( "when list has multiple items", function()
    ...
    describe( "unshift()", function()
        ...
        describe( "when list has items", function()
    ...
    describe( "length()", function()
        ...
        describe( "when list is short", function()
        ...
        describe( "when list has been modified", function()
            local q = List:new()
            for i = 1, 20 do
                q:push( 'foo' )
            end
    ...
    describe( "isEmpty()", function()
        ...
        describe( "when list is non-empty", function()
        ...
        describe( "when list has been emptied", function()
            local q = List:new()
            q:push( 'foo' )
            q:push( 'bar' )
            q:pop()
