...
describe( "EntityManager", function()
    describe( "new()", function()
        describe( "When no templates provided", function()
        ...
        describe( "When templates provided", function()
    ...
    describe( "createEntity()", function()
        ...
        describe( "when only entity template provided", function()
        ...
        describe( "when adding components without template", function()
            local overrides = {
        ...
        describe( "when specifying both template and overrides", function()
            local overrides = {
                identity = { first_name = 'Susan' }, position = { x = -4 },
            }
            local tags = { 'susan', 'awesome' }
        ...
        describe( "when making multiple instances", function()
    ...
    describe( "addTagsToEntity()", function()
        local EM = EntityManager:new( entity_templates, component_templates )
        describe( "when tags is nil", function()
        ...
        describe( "when tags is an empty list", function()
            local e1 = EM:createEntity( 'person', nil, { 'chocolate' } )
        ...
        describe( "when a single tag is specified", function()
            local e1 = EM:createEntity( 'person', nil, { 'chocolate' } )
        ...
        describe( "when multiple tags specified", function()
            local e1 = EM:createEntity( 'person', nil, { 'chocolate' } )
    ...
    describe( "removeTagFromEntity()", function()
        ...
        describe( "when tag is valid", function()
            local e1 = EM:createEntity( 'person', nil, { 'tag1', 'tag2', 'tag3' } )
        ...
        describe( "when tag is not present", function()
            local e1 = EM:createEntity( 'person', nil, { 'tag1', 'tag2', 'tag3' } )
    ...
    describe( "removeTagsFromEntity()", function()
        ...
        describe( "when multiple tags are specified", function()
    ...
    describe( "deleteEntity()", function()
        ...
        describe( "when entity is waiting to be reaped", function()
    ...
    describe( "reapEntities()", function()
        ...
        local id1 = e1.id
        local id2 = e2.id
        describe( "when there are no entities to reap", function()
            EM:reapEntities()
            it( "empties the list of deleted entities", function()
                assert.is_same( {}, EM.deleted_entities )
            end)
        end)
        describe( "when there are entities to reap", function()
            EM:deleteEntity( e1 )
            EM:reapEntities()
            it( "empties the list of deleted entities", function()
                assert.is_same( {}, EM.deleted_entities )
    ...
    describe( "deleteAllEntities()", function()
        ...
        describe( "when there are entities", function()
            local EM = EntityManager:new( entity_templates, component_templates )
